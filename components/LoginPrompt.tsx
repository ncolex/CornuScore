...
const LoginPrompt: React.FC<LoginPromptProps> = ({ message }) => {
  return (
    <div className="absolute inset-0 bg-white/50 backdrop-blur-sm flex flex-col items-center justify-center z-10 rounded-2xl p-4 text-center">
      <i className="fa-solid fa-lock text-4xl text-pink-500 mb-3"></i>
      <p className="text-lg font-bold text-gray-800 mb-4">{message}</p>
      <Link 
        to="/login"
