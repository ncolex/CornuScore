        ...
        {isWebLoading ? (
          ...
          <div className="space-y-4">
            {webResults.length > 0 ? (
              ...
              <p className="text-center text-gray-500 dark:text-gray-400 bg-white/80 dark:bg-gray-800/80 p-6 rounded-xl shadow-md">
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-8">
        <div className="text-center bg-white/80 dark:bg-gray-800/80 p-8 rounded-2xl shadow-lg">
          ...
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Aún no hay reseñas para "{query}"</h2>
