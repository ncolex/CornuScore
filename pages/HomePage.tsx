  ...
  return (
    <div className="flex flex-col items-center justify-center text-center -mt-8 min-h-[70vh]">
      ...
      <button 
        ...
        className="mt-6 px-12 py-4 text-xl font-bold text-white bg-pink-500 rounded-full shadow-lg hover:bg-pink-600 transform hover:scale-105 transition-all disabled:bg-gray-400 disabled:cursor-wait flex items-center justify-center"
      >
        {isLoading ? (
          <>
