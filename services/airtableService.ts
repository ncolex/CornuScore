...
export const submitReview = async (reviewData: { personIdentifier: string, country: string, phoneNumber?: string, category: ReviewCategory, text: string, score: number, pseudoAuthor: string, evidenceUrl?: string }): Promise<boolean> => {
